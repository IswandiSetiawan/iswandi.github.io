        ...
        <div class="form-input">
            <form method="post" action="proses_edit.php" enctype="multipart/form-data">
                <table cellpadding="8" border="0">
                    <tr>
                        <td class="inp"><input type="hidden" name="kd" value="<?php echo $data['kd'];?>"></td>
                    </tr>
                    <tr>
                        <td class="inp"><input type="hidden" name="id" value="<?php echo $data['id'];?>"></td>
                    </tr>
                    <tr>
                        <td class="inp"><input type="hidden" name="kode_barang" value="<?php echo $data['kode_barang'];?>"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="inp"><input type="hidden" name="harga" value="<?php echo $data['harga'];?>"></td>
                    </tr>
                    <tr>
                        <td class="inp"><input type="hidden" name="total" value="<?php echo $data['total'];?>"></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <a href="keranjang.php"></a><input type="submit" value="Simpan">
                            <a href="keranjang.php"></a><button>Batal</button>
                        </td>
                    </tr>
                </table>
        </div>
